...
public class FindNumberOfFullNodes {
	...
	public static void main(String[] args) {
		...
		FindNumberOfFullNodes tree = new FindNumberOfFullNodes();
		...
		System.out.println();
		System.out.println("Number of Full Nodes Found: "+tree.findNumOfFullNodes(tree.root));
		
	

	}
	public int findNumOfFullNodes(TreeNode rootNode)
	{
