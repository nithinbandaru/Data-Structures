...
public class FindMaxWithOutRecursion {
	...
	public static void main(String[] args) {
		...
		FindMaxWithOutRecursion tree = new FindMaxWithOutRecursion();
		...
		System.out.println();
		System.out.println("Max without recursion: "+tree.findMaxNoRecursion(tree.root));
		

	}
	
	public int findMaxNoRecursion(TreeNode rootNode)
	{
